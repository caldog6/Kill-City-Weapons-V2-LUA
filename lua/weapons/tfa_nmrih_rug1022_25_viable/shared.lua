...
SWEP.PrintName = "Ruger 10/22 Full-Auto Conversion"
...
SWEP.Primary.StaticRecoilFactor = 0.95	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
